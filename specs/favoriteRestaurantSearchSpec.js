...
describe('Searching restaurants', () => {
  ...
  describe('When query is not empty', () => {
    ...
    it('should show the found restaurants', () => {
      presenter._showFoundRestaurants([{ id: 'rqdv5juczeskfw1e867' }]);
    ...
    it('should show undefined when the restaurant returned does not contain a title', (done) => {
      document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
        const restaurantTitles = document.querySelectorAll('.post-item__title');
        expect(restaurantTitles.item(0).textContent).toEqual('undefined');
